  ...
  return (
    <header>
      <div className="header-top-info">
        ...
        <div className="icon-container desktop-content">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
            data-icon="whatsapp"
            className="svg-inline--fa fa-whatsapp fa-w-14 icon"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
      ...
      <ul className="breadcrumb-container">
        ...
        <li className="breadcrumb-item">
          <svg
            ...
            className="svg-inline--fa fa-chevron-left fa-w-10 breadcrumb-chevron"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 320 512"
          >
        ...
        <li className="breadcrumb-item desktop-content">Bolsas favoritas</li>
      </ul>
    </header>
  );
};
