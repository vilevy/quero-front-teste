      ...
      <div className="footer-top-info">
        <div className="footer-top-larger">
          ...
          <div className="footer-top-larger-text">
            ...
            <span className="footer-top-text-bottom mobile-content">
              Segunda a sexta de 8h às 22h
            </span>
            <span className="footer-top-text-bottom desktop-content">
              Seg - Sex 8h-22h
            </span>
          </div>
        </div>
        <div className="footer-top-small-container">
          <div className="footer-top-small-item">
            ...
            <div className="footer-top-small-item-text">
              <span className="mobile-content">Chat</span>
              <span className="footer-top-text-top desktop-content">Chato ao vivo</span>
              <span className="footer-top-text-bottom desktop-content">Seg - Sex 8h-22h</span>
            </div>
          </div>
          <div className="footer-top-small-item">
            <svg
            ...
            <div className="footer-top-small-item-text">
              ...
              <span className="footer-top-text-top desktop-content">Mande um e-mail</span>
              <span className="footer-top-text-bottom desktop-content">Respondemos rapidinho</span>
            </div>
          </div>
          <div className="footer-top-small-item">
            <svg
            ...
            <div className="footer-top-small-item-text">
              ...
              <span className="footer-top-text-top desktop-content">Central de ajuda</span>
              <span className="footer-top-text-bottom desktop-content">
